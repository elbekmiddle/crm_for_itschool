...
import { Save, AlertTriangle, LogOut, CheckCircle2 } from 'lucide-react';
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          />
          <div className="fixed inset-0 flex items-center justify-center p-6 z-[201]">
            <motion.div
              initial={{ opacity: 0, scale: 0.9, y: 20 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.9, y: 20 }}
              className="bg-white w-full max-w-lg rounded-[2rem] shadow-2xl overflow-hidden p-8 text-center space-y-6 relative"
            >
