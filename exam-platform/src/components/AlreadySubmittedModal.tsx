  ...
  return createPortal(
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-white rounded-3xl shadow-2xl p-8 animate-in-scale z-10 text-center">
        ...
        <p className="text-slate-500 font-medium mb-6">Bu imtihon allaqachon topshirilgan. Qayta kirish mumkin emas.</p>
        <button type="button" onClick={onGoHome} className="w-full btn-primary">
